...
def prepair_datasets(n_frame=512, n_shift=128, n_mfcc=12):
...
if __name__ == "__main__":
    ...
    if os.path.exists('pretrained_model.pkl'):
        ...
        VADClassifier = pickle.load(open('pretrained_model.pkl', 'rb'))
    else:
        print('Training model.')
        task2Ppl.train(VADClassifier, train_set_path, train_label_path)
        # save model
        pickle.dump(VADClassifier, open('pretrained_model.pkl', 'wb'))
